...
public class EspressoXMLInstrumentationTestRunner extends MonitoringInstrumentation
		...
		private void recordTestResult(int resultCode, Bundle results)
			...
			if (resultCode != REPORT_VALUE_RESULT_OK) {
				...
				if (stack != null) {
					...
					mTestSuiteSerializer.attribute(null, "time", String.format("%.3f", time)); //add time 2014.9.19
